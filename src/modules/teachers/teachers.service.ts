...
import { Role, TeacherHistoryType, Prisma } from '@prisma/client';
...
export class TeachersService {
  ...
  async create(
    ...
    currentUser: { id: number; role: Role; branchId?: number },
  ...
  async update(id: number, dto: UpdateTeacherDto, file?: Express.Multer.File) {
    ...
    const dataToUpdate: Prisma.TeacherUpdateInput = { ...dto };
